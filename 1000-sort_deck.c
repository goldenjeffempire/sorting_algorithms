...
/**
 * swap_next - Swaps a node with its next node.
 *
 * @deck: Address of the pointer to the head.
...
/**
 * sort_deck - Sorts the deck using the Cocktail Shaker sort.
 *
